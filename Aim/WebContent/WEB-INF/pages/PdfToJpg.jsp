...
<body>
    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content row">
          <div class="col-lg-12">
            <p class="sub text-uppercase">Want to convert a PDF file into a image file. Then, this option will provide you the best facility.</p>
            <h3><span>PDF</span><br />TO IMAGE<span></span></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <form action="/Aim/PdfToImage" method="post" enctype="multipart/form-data">
    <section class="feature_product_area section_gap_bottom_custom">
      <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>LET's MAKE IT IMAGE</span></h2>
         </div>
        </div>
      </div>
      </div>
