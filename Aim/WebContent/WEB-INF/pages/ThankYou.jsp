    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content row">
          <div class="col-lg-12">
            <p class="sub text-uppercase">Thank You for using us.</p>
            <h3><span>THANK</span><br /><span>YOU</span></h3>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-12">
            <div class="main_title">
              <div>
                <button type="submit" class="main_btn mb-20 mt-5">BACK TO HOME</button>
              </div>
          </div>
        </div>
      </div>
