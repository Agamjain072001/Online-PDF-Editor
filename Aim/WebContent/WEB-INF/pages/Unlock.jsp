...
<body>
    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content row">
          <div class="col-lg-12">
            <p class="sub text-uppercase">Want to unlock your PDF.Then,this option is for you.</p>
            <h3><span>UNLOCK</span><br />PDF<span></span></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <form action="/Aim/unlockPdf" method="post" enctype="multipart/form-data">
    <section class="feature_product_area section_gap_bottom_custom">
      <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>LET's UNLOCK IT</span></h2>
         </div>
        </div>
      </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="main_title">
              <div class="input_fields_wrap">
                ...
                <div><input class="form-control" type="password" name="password" placeholder="Enter your previous password" ></div>
              </div>
              <div>
