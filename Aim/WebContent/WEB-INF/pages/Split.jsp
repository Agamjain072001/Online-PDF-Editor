...
<body>
    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content row">
          <div class="col-lg-12">
            <p class="sub text-uppercase">Want to Split PDF in to different single page PDF then, this option is only for you.</p>
            <h3><span>SPLIT</span><br />PDF<span></span></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <form action="/Aim/splitPdf" method="post" enctype="multipart/form-data">
    <section class="feature_product_area section_gap_bottom_custom">
      <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>LET's SPLIT IT</span></h2>
         </div>
        </div>
      </div>
      </div>
