...
<body>
                ...
                <ul class="nav navbar-nav center_nav pull-right">
                  ...
                  <li class="nav-item submenu dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li class="nav-item">
                        <a class="nav-link" href="/Aim/split">UNLOCK PDF</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="/Aim/merge">MERGE PDF</a>
                      </li>
    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content row">
          <div class="col-lg-12">
            <p class="sub text-uppercase">Download your File here.</p>
            <h3><span>DOWNLOAD</span><br /><span></span></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <form action="/Aim/download" method="post">
          ...
          <div class="col-lg-12">
            <div class="main_title">
              <div>
                ...
                <button type="submit" class="main_btn mb-20 mt-5">DOWNLOAD YOUR FILE</button>
              </div>
          </div>
        </div>
      </div>
