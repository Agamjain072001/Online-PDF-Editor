  ...
  $(document).ready(function() {
   ...
   $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
         ...
         //text box increment
            $(wrapper).append('<div><input class="form-control" type="file" name="userfiles"/><a href="#" class="remove_field click-btn btn btn-default">Remove</a></div>'); //add input box
            x++; 
    }
    });
...
<body>
            ...
            <div class="row w-100 mr-0">
              ...
              <div class="col-lg-5 pr-0">
                <ul class="nav navbar-nav navbar-right right_nav pull-right">
                  ...
                  <li class="nav-item">
                    <a href="/Aim/register" class="icons">
    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content row">
          <div class="col-lg-12">
            <p class="sub text-uppercase">Combine PDF in the order you want with the easiest merger available.</p>
            <h3><span>MERGE</span><br />PDF<span></span></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <form action="/Aim/mergePdf" method="post" enctype="multipart/form-data">
    <section class="feature_product_area section_gap_bottom_custom">
      <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>LET's MERGE IT</span></h2>
         </div>
        </div>
      </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="main_title">
              <div class="input_fields_wrap">
                <button class="main_btn mb-20 mt-5 add_field_button">Add More Fields</button>
                <div><input class="form-control" type="file" name="userfiles" placeholder="Upload your file" ></div>
                <div><input class="form-control" type="file" name="userfiles" placeholder="Upload your file" ></div>
              </div>
              <div>
                <button type="submit" class="main_btn mb-20 mt-5">Submit</button>
              </div>
          </div>
        </div>
      </div>
